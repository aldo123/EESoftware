  ...
  return (
    <div className="flex-1 flex flex-col bg-[#0F172A] overflow-hidden font-sans">
      ...
      <div className="shrink-0 bg-[#111827] border-b border-[#1E293B] px-4 py-3 flex flex-wrap items-center gap-x-6 gap-y-3">
        ...
        {/* Judul CP (hanya info) */}
        <div className="flex items-center gap-2">
          <span className="text-[#94A3B8] text-[9px] font-bold uppercase tracking-wider">Control Point</span>
        ...
        <div className="flex flex-col gap-1">
          <span className="text-[#94A3B8] text-[9px] font-bold uppercase tracking-wider">Search by Date</span>
          <div className="flex items-center gap-2">
            <span className="text-[#475569] text-[10px]">From</span>
            <Input type="date" value={dateFrom} onChange={e => setDateFrom(e.target.value)} className="w-[130px]" />
            <span className="text-[#475569] text-[10px]">To</span>
        ...
        {/* Search by barcode */}
        <div className="flex flex-col gap-1">
          <span className="text-[#94A3B8] text-[9px] font-bold uppercase tracking-wider">Search by Barcode</span>
          <div className="flex items-center gap-2">
